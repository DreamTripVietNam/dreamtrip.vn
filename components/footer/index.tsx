            ...
            <div className="space-y-4 flex gap-12">
              ...
              <div className="flex flex-col gap-2 pt-4">
                ...
                <p className="text-neutral-500 text-sm leading-relaxed text-justify font-medium">
                  Khám phá vẻ đẹp bất tận của Việt Nam cùng chúng tôi.
                  Tự hào là đơn vị lữ hành hàng đầu mang đến những trải nghiệm du lịch độc đáo, an toàn và đáng nhớ nhất cho bạn và người thân.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center gap-2 group">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-medium text-neutral-400 uppercase tracking-widest">Hotline</span>
                  <div className="text-sm font-medium text-neutral-900 flex items-center gap-2">
                    <a href="tel:0975647798" className="hover:text-teal-600 transition-colors">0975.647.798</a>
                    <span className="text-neutral-300">/</span>
                    <a href="tel:0387176583" className="hover:text-teal-600 transition-colors">0387.176.583</a>
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 group">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-medium text-neutral-400 uppercase tracking-widest">Địa chỉ</span>
              ...
              <div className="flex items-center gap-2 group">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-medium text-neutral-400 uppercase tracking-widest">Email</span>
                  <a
