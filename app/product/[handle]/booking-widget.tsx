...
export function BookingWidget() {
	...
	return (
		<div className="sticky top-24 bg-white  border border-neutral-200  rounded-2xl shadow-xl shadow-neutral-100/50  p-6 overflow-hidden">
			<style>{css}</style>
			...
			<div className="border border-neutral-200  rounded-xl mb-4 overflow-hidden">
				...
				<button
					...
					className="w-full grid grid-cols-2 border-b border-neutral-200  text-left"
				>
					<div className="p-3 border-r border-neutral-200  hover:bg-neutral-50 transition-colors">
				...
				<div
					className={clsx(
						"bg-neutral-50  overflow-hidden transition-all duration-300 ease-in-out",
						isCalendarOpen
							? "max-h-[350px] border-b border-neutral-200 "
							: "max-h-0",
					)}
				>
				...
				{/* Guests */}
				<div className="p-3 flex items-center justify-between hover:bg-neutral-50 transition-colors cursor-pointer group">
					<div>
						<span className="block text-[10px] uppercase font-bold text-neutral-500 tracking-wider">
							Khách
						</span>
			...
			<button
				type="button"
				className="w-full bg-linear-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-white font-bold py-3.5 rounded-xl mb-4 shadow-lg shadow-rose-200  transition-all"
			>
				Đặt phòng ngay
			</button>
